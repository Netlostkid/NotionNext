...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Max', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '沉迷技术无法自拔中', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.netlostkid.com/', // 网站地址
  ...
  FACEBOOK_PAGE_ID: process.env.NEXT_PUBLIC_FACEBOOK_PAGE_ID || '202025262998258', // Facebook Page ID 來啟用 messenger 聊天功能
  FACEBOOK_APP_ID: process.env.NEXT_PUBLIC_FACEBOOK_APP_ID || '1748181625621818', // Facebook App ID 來啟用 messenger 聊天功能 获取: https://developers.facebook.com/
